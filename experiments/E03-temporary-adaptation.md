...
R03 defines the shared generator/scorer/split contract in [its merged and independently reviewed protocol](../docs/R03-generator-scorer-split-protocol.md). R06 chooses the base checkpoint, trainable subset, update loss, optimizer, maximum steps, reset verification, support/query counts, and final statistical protocol. The large benchmark gains in cited prior work are motivation, not expected outcomes for this project.
